# ZEILER .me - IT & Medien, Geschichte, Deutsch - Windows
...
-   [Julian Zeiler](../../../julian.html)
    ...
    -   [Techzap](../../techzap.html)
        ...
        -   [Server](../server.html)
            ...
            -   [Unix/Linux](unix-linux.html)
                
                -   [Mit grep Zeilen entfernen, die in zwei Dateien doppelt vorkommen](unix-linux/grep-in-zwei-dateien-vorkommende-zeilen-entfernen.html)
                    
                
            -   [Windows](windows.html)
                
                -   [IIS und Apache auf einem Server parallel betreiben](windows/iis-und-apache-auf-einem-server-parallel-betreiben.html)
                    
                -   [ListenOnlyList Registry Werte - IIS an IP binden](windows/listenonlylist-registry-werte-iis-an-ip-binden.html)
...
-   [**Problem: IIS bindet nur an bestimmte IP-Adressen oder an alle vorhandenen**](windows/listenonlylist-registry-werte-iis-an-ip-binden.html)
-   [Wenn IIS auf einem bestimmten Port auf Anfragen reagieren soll, bindet er in der Regel an alle vorhandenen IP-Adressen. Die folgende Lösung zeigt, wie man IIS über den Registry Schlüssel ListenOnlyList so einstellen kann, dass er nur noch auf einer IP-Adresse antwortet.](windows/listenonlylist-registry-werte-iis-an-ip-binden.html)
-   [**Problem: IIS und Apache sollen auf einem Server parallel betrieben werden**](windows/iis-und-apache-auf-einem-server-parallel-betreiben.html)
