# ZEILER .me - IT & Medien, Geschichte, Deutsch - Server
...
-   [Detlef Zeiler](../../detlef.html)
    ...
    -   [Deutsch](../../detlef/deutsch.html)
        ...
        -   [Textinterpretation (Beispiele)](../../detlef/deutsch/textinterpretation.html)
            ...
            -   [Einige Beispiele](../../detlef/deutsch/textinterpretation/einige-beispiele.html)
                ...
                -   [Wie ist der Mensch? (Michel de Montaigne)](../../detlef/deutsch/textinterpretation/einige-beispiele/wie-ist-der-mensch-michel-de-montaigne.html)
    ...
    -   [Geschichte](../../detlef/geschichte.html)
        ...
        -   [Nicht-tödliche Waffen](../../detlef/geschichte/nicht-tdliche-waffen.html)
    ...
    -   [Medien](../../detlef/medien.html)
        ...
        -   [Medienerziehung](../../detlef/medien/medienerziehung.html)
            ...
            -   [Zukünftige Ansatzpunkte](../../detlef/medien/medienerziehung/zukuenftige-ansatzpunkte.html)
    ...
    -   [Projekte](../../detlef/projekte.html)
        ...
        -   [Dritte Gewalt - Strafvollzug](../../detlef/projekte/dritte-gewalt-strafvollzug.html)
            ...
            -   [Beispiel für ein Projekt](../../detlef/projekte/dritte-gewalt-strafvollzug/beispiel-fuer-ein-projekt.html)
        ...
        -   [Heidelberg im Mittelalter](../../detlef/projekte/heidelberg-im-mittelalter.html)
            ...
            -   [Strafrecht und Strafvollzug](../../detlef/projekte/heidelberg-im-mittelalter/strafrecht-und-strafvollzug.html)
                ...
                -   [I. Strafe - der Triumph des Guten](../../detlef/projekte/heidelberg-im-mittelalter/strafrecht-und-strafvollzug/triumph-des-guten.html)
        ...
        -   [Heidelberger Schulgeschichten](../../detlef/projekte/heidelberger-schulgeschichten.html)
            ...
            -   [Die Anfänge](../../detlef/projekte/heidelberger-schulgeschichten/anfaenge.html)
...
-   [Julian Zeiler](../../julian.html)
    ...
    -   [Techzap](../techzap.html)
        ...
        -   [Design](design.html)
            ...
            -   [Microsoft Paint](design/microsoft-paint.html)
                
                -   [favicon ico mit MS Paint und BMP2ICO erstellen](design/microsoft-paint/favicon-ico-mit-ms-paint-und-bmp2ico-erstellen.html)
                    
                
            
        -   [Programmierung](programmierung.html)
            
            -   [Einführung in das Programmieren (alt und unvollendet)](programmierung/einfuehrung-in-das-programmieren.html)
                
                -   [Einführung in die Programmierung - Kapitel 1: Die Grundlagen](programmierung/einfuehrung-in-das-programmieren/grundlagen-variablen-operatoren-funktionen.html)
                    
                
            -   [Perl](programmierung/perl.html)
                
                -   [Perl Einzeiler: Suchen und Ersetzen in Dateien](programmierung/perl/perl-einzeiler-suchen-und-ersetzen-in-dateien.html)
                    
                
            
        -   [Server](server.html)
            
            -   [Unix/Linux](server/unix-linux.html)
                
                -   [Mit grep Zeilen entfernen, die in zwei Dateien doppelt vorkommen](server/unix-linux/grep-in-zwei-dateien-vorkommende-zeilen-entfernen.html)
                    
                
            -   [Windows](server/windows.html)
                
                -   [IIS und Apache auf einem Server parallel betreiben](server/windows/iis-und-apache-auf-einem-server-parallel-betreiben.html)
                    
                -   [ListenOnlyList Registry Werte - IIS an IP binden](server/windows/listenonlylist-registry-werte-iis-an-ip-binden.html)
                    
                
            
        -   [Technik](technik.html)
            
            -   [VMware](technik/vmware.html)
                
                -   [Strg+Alt+F1 bzw Ctrl+Alt+F1 an VMware senden](technik/vmware/strg-alt-f1-bzw-ctrl-alt-f1-an-vmware-senden.html)
...
-   [**Problem: Es sollen zwei Dateien verglichen werden und dabei alle Zeilen der ersten Datei, die ebenfalls in der zweiten Datei vorkommen, entfernt werden.**](server/unix-linux/grep-in-zwei-dateien-vorkommende-zeilen-entfernen.html)
-   [Der Unix/Linux Befehl grep wird meistens dafür verwendet nach einem bestimmten Ausdruck zu filtern. Man kann ihn jedoch auch mit Ausdrücken füttern, die nicht vorkommen sollen.](server/unix-linux/grep-in-zwei-dateien-vorkommende-zeilen-entfernen.html)
-   [Bei unserem Problem benötigen wir diese Funktion, denn wir wollen alle Zeilen aus Datei A, die nicht ebenfalls in Datei B vorkommen ausgeben lassen.](server/unix-linux/grep-in-zwei-dateien-vorkommende-zeilen-entfernen.html)
-   [**Problem: IIS bindet nur an bestimmte IP-Adressen oder an alle vorhandenen**](server/windows/listenonlylist-registry-werte-iis-an-ip-binden.html)
-   [Wenn IIS auf einem bestimmten Port auf Anfragen reagieren soll, bindet er in der Regel an alle vorhandenen IP-Adressen. Die folgende Lösung zeigt, wie man IIS über den Registry Schlüssel ListenOnlyList so einstellen kann, dass er nur noch auf einer IP-Adresse antwortet.](server/windows/listenonlylist-registry-werte-iis-an-ip-binden.html)
-   [**Problem: IIS und Apache sollen auf einem Server parallel betrieben werden**](server/windows/iis-und-apache-auf-einem-server-parallel-betreiben.html)
-   [Um die Web-Server IIS und Apache parallel betreiben zu können, muss ein Server, in diesem Fall Apache, alle HTTP-Anfragen annehmen und diese bei bestimmten Webseiten an den anderen Server, in diesem Fall IIS, weiterleiten bzw. diese durchschleifen.](server/windows/iis-und-apache-auf-einem-server-parallel-betreiben.html)
